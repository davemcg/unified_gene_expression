...
```{r, message = FALSE}
all_go_tester <- function(limma_data){
  ...
  for (i in names(up_expressed_sets)){
    up_go_terms[[i]] <- GO_enrichment(up_expressed_sets[[i]], background_genes ,'BP')
  }
up_go_terms
}
```
...
```{r, message = FALSE}
go_enrichment <- list(retina.adult_vs_rpe.adult_up=retina_rpe_GO_up,
                      retina.adult_vs_rpe.adult_down=retina_rpe_GO_down, 
                      cornea.adult_vs_retina.adult_rpe_GO_up=cornea_vs_retina_rpe_GO_up,
                      cornea.adult_vs_retina.adult_rpe_GO_down=cornea_vs_retina_rpe_GO_down,
                      ...
                      retina.adult_vs_retina.stem_up=test5_up_go,  # adult retina vs stem retina
                      retina.adult_vs_retina.stem_down=test5_down_go)
