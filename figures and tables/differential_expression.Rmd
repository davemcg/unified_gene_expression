...
the_table <- test_summaries %>% 
  ...
  dplyr::select(Test, Comparison, `LogFC < -1`, `LogFC > 1`) %>% filter(Test!='F')
...
test1_comps <- list('Cornea vs Retina' = test1_contrast_genes$Cornea.adult_vs_Retina.adult, 
                   'Cornea vs RPE' = test1_contrast_genes$Cornea.adult_vs_RPE.adult, 
                   'Retina vs RPE' = test1_contrast_genes$Retina.adult_vs_RPE.adult)
upset(fromList(test1_comps),mainbar.y.max = 2000, keep.order = T, sets.bar.color = '#3eb9c4', matrix.color = '#3eb9c4', main.bar.color = '#3eb9c4', set_size.angles = 45)
...
test1_comps <- list('Cornea vs Retina' = test1_contrast_genes$Cornea.adult_vs_Retina.adult, 
                   'Cornea vs RPE' = test1_contrast_genes$Cornea.adult_vs_RPE.adult, 
                   'Retina vs RPE' = test1_contrast_genes$Retina.adult_vs_RPE.adult)
upset(fromList(test1_comps),mainbar.y.max = 2000, keep.order = T, sets.bar.color = '#ef6d62', matrix.color = '#ef6d62', main.bar.color = '#ef6d62', set_size.angles = 45)
```
...
go_printer2(retina_rpe_GO_up,8,'RPE > Retina')
...
go_printer2(retina_rpe_GO_down,8,'RPE < Retina')
```
...
go_printer2(cornea_vs_retina_rpe_GO_up,8, 'RPE and Retina > Cornea')
...
go_printer(cornea_vs_retina_rpe_GO_down,8, 'RPE and Retina < Cornea')
...
test2_comps <- list('ESC vs Retina (stem cell)' = test2_contrast_genes$ESC.stemcell_vs_Retina.stemcell, 
                   'ESC vs RPE (stem cell)' = test2_contrast_genes$ESC.stemcell_vs_RPE.stemcell, 
                   'Retina (stem cell) vs RPE (stem cell)' = test2_contrast_genes$Retina.stemcell_vs_RPE.stemcell)
upset(fromList(test2_comps), keep.order = T, mainbar.y.max = 1800, sets.bar.color = '#3eb9c4', matrix.color = '#3eb9c4', main.bar.color = '#3eb9c4', set_size.angles = 45)

test2_contrast_genes <- contrast_DOWNgene_lists(big_six[[2]])
test2_comps <- list('ESC vs Retina (stem cell)' = test2_contrast_genes$ESC.stemcell_vs_Retina.stemcell, 
                   'ESC vs RPE (stem cell)' = test2_contrast_genes$ESC.stemcell_vs_RPE.stemcell, 
                   'Retina (stem cell) vs RPE (stem cell)' = test2_contrast_genes$Retina.stemcell_vs_RPE.stemcell)
upset(fromList(test2_comps), keep.order = T, mainbar.y.max = 1800, sets.bar.color = '#ef6d62', matrix.color = '#ef6d62', main.bar.color = '#ef6d62', set_size.angles = 45)
```
GO enrichment
```{r, message = FALSE}
...
go_printer(retina.stem_vs_rpe.stem_up, 8, 'Stem Cell RPE > Stem Cell Retina')
...
go_printer(retina.stem_vs_rpe.stem_down, 8, 'Stem Cell RPE < Stem Cell Retina')
...
go_printer(coef2_up_GO %>% filter(`Expected Count` > 0.8),8, 'Adult RPE > Stem Cell RPE')
...
go_printer(coef2_down_GO %>% filter(`Expected Count` > 0.8),8, 'Adult RPE < Stem Cell RPE')
...
```{r, message = FALSE}
go_enrichment <- list(retina_rpe_GO_up=retina_rpe_GO_up,
                      retina_rpe_GO_down=retina_rpe_GO_down, 
                      cornea_vs_retina_rpe_GO_up=cornea_vs_retina_rpe_GO_up,
                      cornea_vs_retina_rpe_GO_down=cornea_vs_retina_rpe_GO_down,
                      retina.stem_vs_rpe.stem_up=retina.stem_vs_rpe.stem_up,
                      retina.stem_vs_rpe.stem_down=retina.stem_vs_rpe.stem_down,
                      esc_vs_rpe.stem_up=esc_vs_rpe.stem_up,
                      esc_vs_rpe.stem_down=esc_vs_rpe.stem_down,
                      rpe.stem_vs_rpe.adult_up=coef2_up_GO, #rpe stem vs rpe adult
                      rpe.stem_vs_rpe.adult_down=coef2_down_GO,
                      cell.rpe_vs_stem.rpe_up=test4_up_go, #cell rpe vs stem rpe
                      cell.rpe_vs_stem.rpe_down=test4_down_go,
                      adult.retina_vs_stem_up=test5_up_go,  # adult retina vs stem retina
                      adult.retina_vs_stem_down=test5_down_go)
