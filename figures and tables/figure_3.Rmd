...
test_summaries %>% mutate(`Test #`=c(1,1,1,2,2,2,3,3,3,4,5,6,6,6)) %>% mutate(Comparison = paste(Comparison, Reference, sep = ' vs ')) %>% select(`Test #`, Comparison, `LogFC < -1`, `LogFC > 1`)
```
...
test1_sets <- set_maker(test1_contrast_genes$Cornea.adult_vs_Retina.adult, test1_contrast_genes$Cornea.adult_vs_RPE.adult, test1_contrast_genes$Retina.adult_vs_RPE.adult)
