...
# same, but return topTable (for two sample tests)
limma_voom_test_twoSample <- function(lmFit_object, your_custom_contrast_matrix){
  vfit.cont <- contrasts.fit(lmFit_object, contrasts = your_custom_contrast_matrix)
  efit <- eBayes(vfit.cont)
  print(summary(decideTests(efit, lfc = 1, p.value = 0.05, adjust.method = 'fdr')))
  topTable(efit, number=30000, adjust.method='fdr')
}
```
...
cont.matrix <- makeContrasts(RPE.stemcell_vs_RPE.immortalizedcell="RPE_Stem.Cell.Line-RPE_Cell.Line",
                             levels=design) 
test4 <- limma_voom_test_twoSample(vfit, cont.matrix)
```
...
cont.matrix <- makeContrasts(Retina.adult_vs_Retina.stemcell="Retina_Adult.Tissue-Retina_Stem.Cell.Line",
                             levels=design) 
test5 <- limma_voom_test_twoSample(vfit, cont.matrix)
```
...
cont.matrix_all <- makeContrasts(RPE_Stem.Cell.Line_vs_RPE_Fetal.Tissue="RPE_Stem.Cell.Line-RPE_Fetal.Tissue",
 RPE_Stem.Cell.Line_vs_Retina_Adult.Tissue="RPE_Stem.Cell.Line-Retina_Adult.Tissue",
 RPE_Stem.Cell.Line_vs_RPE_Adult.Tissue="RPE_Stem.Cell.Line-RPE_Adult.Tissue",
 RPE_Stem.Cell.Line_vs_RPE_Cell.Line="RPE_Stem.Cell.Line-RPE_Cell.Line",
 RPE_Stem.Cell.Line_vs_ESC_Stem.Cell.Line="RPE_Stem.Cell.Line-ESC_Stem.Cell.Line",
 RPE_Stem.Cell.Line_vs_Retina_Stem.Cell.Line="RPE_Stem.Cell.Line-Retina_Stem.Cell.Line",
 RPE_Stem.Cell.Line_vs_Cornea_Adult.Tissue="RPE_Stem.Cell.Line-Cornea_Adult.Tissue",
 RPE_Stem.Cell.Line_vs_Cornea_Fetal.Tissue="RPE_Stem.Cell.Line-Cornea_Fetal.Tissue",
 RPE_Stem.Cell.Line_vs_Cornea_Cell.Line="RPE_Stem.Cell.Line-Cornea_Cell.Line",
 ...
 RPE_Fetal.Tissue_vs_Retina_Stem.Cell.Line="RPE_Fetal.Tissue-Retina_Stem.Cell.Line",
 ...
 RPE_Fetal.Tissue_vs_Cornea_Cell.Line="RPE_Fetal.Tissue-Cornea_Cell.Line",
 ...
 Retina_Adult.Tissue_vs_Retina_Stem.Cell.Line="Retina_Adult.Tissue-Retina_Stem.Cell.Line",
 ...
 Retina_Adult.Tissue_vs_Cornea_Cell.Line="Retina_Adult.Tissue-Cornea_Cell.Line",
 ...
 RPE_Adult.Tissue_vs_Retina_Stem.Cell.Line="RPE_Adult.Tissue-Retina_Stem.Cell.Line",
 ...
 RPE_Adult.Tissue_vs_Cornea_Cell.Line="RPE_Adult.Tissue-Cornea_Cell.Line",
 RPE_Cell.Line_vs_ESC_Stem.Cell.Line="RPE_Cell.Line-ESC_Stem.Cell.Line",
 RPE_Cell.Line_vs_Retina_Stem.Cell.Line="RPE_Cell.Line-Retina_Stem.Cell.Line",
 ...
 RPE_Cell.Line_vs_Cornea_Cell.Line="RPE_Cell.Line-Cornea_Cell.Line",
 ESC_Stem.Cell.Line_vs_Retina_Stem.Cell.Line="ESC_Stem.Cell.Line-Retina_Stem.Cell.Line",
 ESC_Stem.Cell.Line_vs_Cornea_Adult.Tissue="ESC_Stem.Cell.Line-Cornea_Adult.Tissue",
 ESC_Stem.Cell.Line_vs_Cornea_Fetal.Tissue="ESC_Stem.Cell.Line-Cornea_Fetal.Tissue",
 ESC_Stem.Cell.Line_vs_Cornea_Cell.Line="ESC_Stem.Cell.Line-Cornea_Cell.Line",
 ...
 Cornea_Adult.Tissue_vs_Cornea_Fetal.Tissue="Cornea_Adult.Tissue-Cornea_Fetal.Tissue",
 Cornea_Adult.Tissue_vs_Cornea_Cell.Line="Cornea_Adult.Tissue-Cornea_Cell.Line",
 Cornea_Fetal.Tissue_vs_Cornea_Cell.Line="Cornea_Fetal.Tissue-Cornea_Cell.Line", levels=design)
```
...
DE_45 <- topTableF(efit_all,number=300000, adjust.method = 'fdr') %>% data.frame()
```
