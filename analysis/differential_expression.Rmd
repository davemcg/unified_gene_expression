...
Update files to import and get eye_samples in same order as eye_files
```{r, message = FALSE}
...
txi.eyeandtex.lsTPM <- data.frame(txi.eyeandgtex.lsTPM_full$counts)
colnames(txi.eyeandgtex.lsTPM) <- eye_and_gtex_samples
```
