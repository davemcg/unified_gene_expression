...
txi.lengthScaledTPM <- tximport(tx_files, type = "kallisto", tx2gene = tx2gene, reader = read_tsv, countsFromAbundance = c("lengthScaledTPM"))
...
colnames(lengthScaledTPM) <- tx_names
